...
the high and low tolerance integrations in figure \ref{fig:Energy1} is xxx\%.
The max percentage difference in figure \ref{fig:Energy2} is xxx\%. The max percentage difference in figure \ref{fig:Energy3} is xxx\%.
